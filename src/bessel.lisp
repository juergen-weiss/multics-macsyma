...

(DEFVAR I-BESSEL-ARRAY (MAKE-ARRAY$ 100.))

(DEFUN I[N]-BESSEL (X N) 
   (PROG (A A0 A1 AN B B0 B1 FI FN Q0 Q1) 
	 (SETQ N (ABS N))
	 (IF (> N 100.) (SETQ I-BESSEL-ARRAY (MAKE-ARRAY$ (1+ N))))
	 (AND (= N 0.) (GO $L9))
	 (SETQ FN (FLOAT (+ N N)))
	 (SETQ Q1 (//$ X FN))
	 (COND ((> (ABS X) 3.0E-4)
...

(DEFVAR G-BESSEL-ARRAY (MAKE-ARRAY$ 100.))

(DEFUN G[N]-BESSEL (X N) 
   (PROG (A A0 A1 AN B B0 B1 FI FN Q0 Q1) 
	 (SETQ N (ABS N))
	 (IF (> N 100.) (SETQ G-BESSEL-ARRAY (MAKE-ARRAY$ (1+ N))))
	 (AND (= N 0.) (GO $L9))
...
(DEFUN BESSEL (RZ CZ A) 
  (PROG (N Y $T T0 T1 K1 D R1 RP SQRP RNPA R2 M TA RN RL MPO LN RNP RR CR RS CS
	...
	(SETQ RJ-BESSEL-ARRAY (MAKE-ARRAY$ LN)
	      CJ-BESSEL-ARRAY (MAKE-ARRAY$ LN))
	(GO L13)
L9	(COND
	 ((NOT (< 10.0 $T))
