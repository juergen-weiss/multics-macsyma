...
(DEFMACRO DEFTRAMP$ (NARGS)
  (LET ((TRAMP$ (SYMBOLCONC 'TRAMP (implode (explode NARGS)) '$))
	#+MACLISP
	(TRAMP$-S (SYMBOLCONC 'TRAMP (implode (explode NARGS)) '$-S))
	(TRAMP$-F (SYMBOLCONC 'TRAMP (implode (explode NARGS)) '$-F))
	(TRAMP$-M (SYMBOLCONC 'TRAMP (implode (explode NARGS)) '$-M))
	(L (MAKE-LIST NARGS)))
